...
public class AppRater {
    ...
    private static final String DEFAULT_TEXT_TITLE = "Do you love Christmas Countdown?";
    private static final String DEFAULT_TEXT_EXPLANATION = "We would be very happy if you could rate our application! Merry Christmas!";
    private static final String DEFAULT_TEXT_NOW = "Rate now";
    private static final String DEFAULT_TEXT_LATER = "Maybe Later";
    private static final String DEFAULT_TEXT_NEVER = "Don't Ask Again";
